...
export function DishCard({ item, onAddToCart, onCardClick, locale = 'en', className }: DishCardProps) {
      ...
      <div className="p-3">
        ...
        <div className="flex items-center justify-between mt-auto">
          <div className="text-primary font-bold">
            ...
            <span className="text-[10px] text-text-muted ms-1 font-normal">KD</span>
          </div>
