	...
	return (
		<div className="hidden print:flex print:flex-col print:w-[80mm] print:mx-auto print:bg-white print:text-black print:text-sm print:font-mono bg-white text-black p-4 w-[80mm] mx-auto font-mono items-center justify-start h-auto origin-top-center">
			...
			<div className="text-center w-full flex flex-col items-center">
				<h2 className="text-xl font-bold mb-1 tracking-tight text-center">
					Tawla Smart Apps
				</h2>
				<h1 className="text-2xl font-black mb-1 uppercase tracking-wider text-center break-words leading-snug">
					{restaurantName}
				</h1>
				<p className="text-sm font-bold uppercase tracking-widest text-[#0A1628] border border-black/20 rounded-md px-3 py-1 mt-1">
			...
			<div className="w-full flex justify-between items-end border-t-4 border-black pt-2 mb-6 text-left hidden print:hidden">
				...
				<span className="font-black text-2xl tracking-tighter tabular-nums">
					{order.total.toFixed(3)} KD
				</span>
			</div>
			...
			<div className="text-center font-bold space-y-1 mt-6 w-full pb-4">
				...
				<div className="mt-4 pt-4 border-t border-black/20 text-center flex flex-col items-center">
					<span className="text-white bg-black rounded-lg px-2 py-0.5 text-[10px] uppercase font-black tracking-widest print-color-adjust-exact">
						Tawla
					</span>
				</div>
			</div>
