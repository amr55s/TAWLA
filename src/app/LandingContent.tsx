...
const translations = {
	en: {
		...
		pricing: {
			...
			p3_f4: "Cross-branch Analytics",
			p3_f5: "Unlimited Staff",
			p3_f6: "Custom Integrations",
			p3_f7: "Dedicated Account Manager",
			btn_starter: "Choose Starter",
			btn_pro: "Upgrade to Pro",
			btn_enterprise: "Go Enterprise",
			custom_price: "Custom",
		},
		cta: {
	...
	ar: {
		...
		pricing: {
			...
			p3_f4: "تحليلات مشتركة للفروع",
			p3_f5: "موظفين بلا حدود",
			p3_f6: "تكاملات مخصصة",
			p3_f7: "مدير حساب مخصص",
			btn_starter: "اختر الباقة المبتدئة",
			btn_pro: "الترقية للاحترافية",
			btn_enterprise: "ابحث عن حلول الشركات",
			custom_price: "مخصص",
		},
		cta: {
