...
export default function ConfirmOrderPage({
  ...
  const tableNumber = typeof tableParam === 'string' ? tableParam : Array.isArray(tableParam) ? tableParam[0] : undefined;
    ...
    <div className="min-h-screen bg-background pb-32">
      ...
      <main className="px-6 py-4">
        ...
        <div className="bg-primary/10 rounded-2xl p-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-text-heading">Table #{order.tableNumber}</p>
            </div>
          </div>
        </div>

        {/* Order Items */}
        <h3 className="text-lg font-bold text-text-heading mb-4">Order Items</h3>
        ...
        <div className="flex justify-between items-center py-4 border-t border-border-light">
          ...
          <span className="text-2xl font-bold text-primary">{order.total.toFixed(3)} KD</span>
        </div>
      </main>
